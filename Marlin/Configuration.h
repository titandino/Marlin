...
#define STRING_CONFIG_H_AUTHOR "Trenton Kress" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3V2 v1.0"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 121.40 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 8 // Extended max to allow the probe to reach more of the bed.
